export const environment = {
  ...
  userOwnInfo:'https://fs-api.phrqltest.com/api/user/own-info',
  ...
  cookieAuth:'https://accounts.phrqltest.com/userpool/login/?origin=https://patient.phrqltest.com',
  redirectURI: 'https://patient.phrqltest.com/userpool/callback/',
  environment:"PRODUCTION",
  appClientId:"6ft9a1rrj34mmcmrrqd9ec7sdo"
};
