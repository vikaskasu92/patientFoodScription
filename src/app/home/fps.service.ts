  ...
  favoritesData:any[] = [];
    ...
    updateMealFavorite(id:number,favorite:boolean){
      return new Promise<any>((resolve,reject)=>{
            this.http.patch<any>("https://fs-api.phrqltest.com/api/recipe/"+id+"/favorite-rating/",{ "favorite":favorite},this.authService.getHeadersObject(true)).subscribe( favoriteUpdate => {
    ...
    storeFoodPreferencesToDB(){
      return new Promise<any>((resolve,reject)=>{
          ...
          },this.authService.getHeadersObject(true)).subscribe( addFavorites => {
    ...
    updateMealRating(rating:number,id:number){
      return new Promise<any>((resolve,reject)=>{
            ...
            this.authService.getHeadersObject(true)).subscribe( addRating => {
                resolve(addRating);
            },err=>{
              reject();
            });
